    ...
    switch($_GET["op"]){
        ...
        case "guardaryeditar":
            ...
            if(empty($_POST["usu_id"])){                
                $usuario->insert_usuario($_POST["suc_id"], 
                                         $_POST["usu_correo"],
                                         $_POST["usu_nom"],
                                         $_POST["usu_ape"],
                                         $_POST["usu_dni"],
                ...
                $usuario->update_usuario($_POST["usu_id"], 
                                        $_POST["suc_id"], 
                                        $_POST["usu_correo"],
                                        $_POST["usu_nom"],
                                        $_POST["usu_ape"],
            ...
            if(is_array($datos) == true and count($datos) > 0){
                foreach ($datos as $row) {
                    ...
                    if($row["USU_IMG"] != ''){
                        ...
                        $output["USU_IMG"] = '<img src="../../assets/images/producto/noimage.jpg" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_usuario_imagen" value="" />';
                    }
                }

                ...
                if ($row["PROD_IMG"] != ''){
                    ...
                    "<div class='d-flex align-items-center'>" .
                        "<div class='flex-shrink-0 me-2'>".
                            "<img src='../../assets/images/producto/".$row["PROD_IMG"]."' alt='' class='avatar-xs rounded-circle'>".
                        "</div>".
                    "</div>";
                }else{
                    $sub_array[] =
                    "<div class='d-flex align-items-center'>" .
                        "<div class='flex-shrink-0 me-2'>".
                            "<img src='../../assets/images/producto/noimage.jpg' alt='' class='avatar-xs rounded-circle'>".
                        "</div>".
                    "</div>";
                }                
        ...
        case "mostrar":
            ...
            if (is_array($datos)==true and count($datos)>0){
                foreach($datos as $row){
                    ...
                    if($row["PROD_IMG"] != ''){
                        $output["PROD_IMG"] = '<img src="../../assets/images/producto/'.$row["PROD_IMG"].'" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_producto_imagen" value="'.$row["PROD_IMG"].'" />';
                    }else{
                        $output["PROD_IMG"] = '<img src="../../assets/images/producto/noimage.jpg" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_producto_imagen" value="" />';
                    }                    
                }

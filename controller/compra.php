<?php
    ...
    switch($_GET["op"]){
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <?php
                                    if ($row["PROD_IMG"] != ''){
                                        ?>
                                            <?php
                                                echo "<img src='../../assets/images/producto/".$row["PROD_IMG"]."' alt='' class='img-fluid d-block' />";
                                            ?>
                                        <?php
                                    }else{
                                        ?>
                                            <?php 
                                                echo "<img src='../../assets/images/producto/noimage.JPG' alt='' class='img-fluid d-block' />";
                                            ?>
                                        <?php
                                    }
                                ?>
                                ...
                                <div class="flex-shrink-0 me-2">
                                    <?php 
                                        if ($row["USU_IMG"] != ''){
                                            ?>
                                                <?php
                                                    echo "<img src='../../assets/images/users/".$row["USU_IMG"]."' alt='' class='avatar-xs rounded-circle' />";
                                                ?>
                                            <?php
                                        }else{
                                            ?>
                                                <?php
                                                    echo "<img src='../../assets/images/producto/noimage.jpg' alt='' class='avatar-xs rounded-circle' />";
                                                ?>
                                            <?php
                                        }
                                    ?>
        ...
        /* TODO: Compras por mes del dashboard */
        case "barras":

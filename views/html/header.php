                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                if($_SESSION["USU_IMG"]==""){
                                    ?>
                                        <img class="rounded-circle header-profile-user" src="../../assets/images/producto/noimage.jpg" alt="Header Avatar">
                                    <?php
                                }else{
                                    ?>
                            ...
                            ?>
                                    <span class="text-start ms-xl-2">
                                        ...
                                        <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Propietario</span>
                                    </span>
                                </span>
                            </button>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="../MntPerfil/">
                                ...
                                <a class="dropdown-item" href="../html/logout.php">
                                    <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> 
                                    <span class="align-middle" data-key="t-logout">Salir</span></a>
                            </div>
                        </div>
                    </div>
                </div>

...
$(document).on("click", "#btnnuevo", function () {
  ...
  $("#pre_imagen").html(
    '<img src="../../assets/producto/no_imagen.png" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_producto_imagen" value="" />'
  );
...
$(document).on("click", "#btnremovephoto", function () {
  $("#prod_img").val("");
  $("#pre_imagen").html(
    '<img src="../../assets/image/producto/noimage.jpg" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image"></img><input type="hidden" name="hidden_producto_imagen" value="" />'
  );
});

...
$.post(
  "../../controller/compra.php?op=listartopproducto",
  { suc_id: suc_id },
  function (data) {
...
$.post(
  "../../controller/venta.php?op=listartopproducto",
  { suc_id: suc_id },
  function (data) {
...
$.post(
  "../../controller/categoria.php?op=stock",
  { suc_id: suc_id },
  function (data) {
...
$.post(
  "../../controller/compra.php?op=compraventa",
  { suc_id: suc_id },
  function (data) {

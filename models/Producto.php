<?php
    ...
    class Producto extends Conectar{
        ...
        /* TODO: Listar Registros por ID especificos */
        ...
        /* TODO: Eliminar o cambiar de estado a eliminado */
        ...
        public function insert_producto($suc_id, $cat_id, $prod_nom, $prod_descrip, $und_id, $mon_id, $prod_pcompra, 
                                        $prod_pventa, $prod_stock, $prod_fechaven, $prod_img){
            $conectar=parent::Conexion();
        ...
        /* Actualizar Datos */
        public function update_producto($prod_id, $suc_id, $cat_id, $prod_nom, $prod_descrip, $und_id, $mon_id, $prod_pcompra, 
                                        $prod_pventa, $prod_stock, $prod_fechaven, $prod_img){
            $conectar=parent::Conexion();
        ...
        public function upload_image(){
            if (isset($_FILES["prod_img"])){
                ...
                $destination = '../assets/images/producto/' . $new_name;

...
<head>
    <meta charset="utf-8" />
    <title>CompraVenta | Acceso </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Sistema Compra-Venta Multisucursal" name="description" />
    <meta content="Compra-Venta" name="author" />
                                        ...
                                        <div class="mt-4">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="usu_correo" id="usu_correo" placeholder="Ingrese Correo Electronico" required>
                                                </div>

                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="auth-pass-reset-cover.html" class="text-muted">¿Olvidó la Contraseña?</a>
                                                    </div>
                                                    <label class="form-label" for="usu_pass">Contraseña</label>
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password" class="form-control pe-5" placeholder="Ingrese Contraseña" name="usu_pass" id="usu_pass" required>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Compra-Venta. Elaborado con <i class="mdi mdi-heart text-danger"></i> por JDCX.
                            </p>
                        </div>
                    </div>
                </div>
